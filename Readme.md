...
# Parsing + Configuration Script – Canup Technoton - Rev. A

This **Parsing + Configuration** script is designed for the **Canup Technoton** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Canup Technoton Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Canup Technoton** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
